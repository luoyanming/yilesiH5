<template>
    ...
    <div class="app-container">
        ...
        <div v-show="ready" class="container-wrapper my-study">
            ...
            <section class="has-study-status" v-infinite-scroll="loadMore" infinite-scroll-disabled="loading" infinite-scroll-distance="10">
...
<script>
    ...
    import { microLessonList } from "../api/api";
    ...
    export default {
        ...
        methods : {
            ...
            getMyStudyList : function() {
                ...
                let params = { periodId: this.currentPeriod, pageNo: this.pageNo, pageSize: this.pageSize };

                microLessonList(params).then(res => {
                    this.loading = false;
                    ...
                    if(code == 0) {
                        ...
                        if(data.courseList.length > 0) {
                            for(let i = 0; i < data.courseList.length; i++) {  
                                this.courseList.push(data.courseList[i]);                                                 
                            }
                        }
                    }else{
